...
(function (global, factory) {
  ...
  FE.LANGUAGE['bs'] = {
    translation: (_translation = {
      ...
      'Improve writing': 'Poboljšaj pisanje',
      'Accept All AI Changes': 'Prihvati sve AI izmjene',
      'Reject All AI Changes': 'Odbij sve AI izmjene',
      'Improve Writing doesn\'t support selections that span multiple table cells. Please select text within a single cell.': 'Poboljšaj pisanje ne podržava odabire koji obuhvataju više ćelija tabele. Molimo odaberite tekst unutar jedne ćelije.',
      'No improvements were suggested.': 'Nisu predložena nikakva poboljšanja.',
      'The selection changed while waiting for a response. Please try again.': 'Odabir se promijenio dok se čekalo na odgovor. Molimo pokušajte ponovo.',
      'Could not match the AI response to the original content. Please try again.': 'Nije bilo moguće uskladiti AI odgovor sa originalnim sadržajem. Molimo pokušajte ponovo.',
      'AI request failed': 'AI zahtjev nije uspio',
      'Hide tracked changes': 'Sakrij praćene izmjene',
      'Show tracked changes': 'Prikaži praćene izmjene',
      'Tracked changes': 'Praćene izmjene',
      ...
      //AI Speech to Text
      'Dictate': 'Diktiraj',
      'Cancel recording': 'Otkaži snimanje',
      ...
      'No speech detected.': 'Govor nije detektovan.',
      'Could not transcribe the audio. Please try again.': 'Nije moguće transkribovati zvuki. Molimo pokušajte ponovo.',
      'Transcription failed': 'Transkripcija nije uspela',
      // AI Terms Consent
      ...
      'Web search': 'Pretraga weba',
      'Reasoning': 'Rezonovanje',
      'Model': 'Model',
      'Send': 'Pošalji',
      'AI can make mistakes. Always review output for accuracy.': 'AI može napraviti greške. Uvijek provjerite tačnost odgovora.',
      'Yes': 'Da',
      'No': 'Ne',
      'Ask AI (web search & reasoning enabled)…': 'Pitajte AI (pretraga weba i rezonovanje omogućeni)…',
      'Ask AI (web search enabled)…': 'Pitajte AI (pretraga weba omogućena)…',
      'Ask AI (reasoning enabled)…': 'Pitajte AI (rezonovanje omogućeno)…',
      'Ask AI…': 'Pitajte AI…',
      'Hi! I\'m your writing assistant.': 'Zdravo! Ja sam vaš asistent za pisanje.',
      'I can help you brainstorm, rewrite, translate, and summarize.': 'Mogu vam pomoći da osmislite ideje, prepišete, prevedete i sažmete tekst.',
      'You can add additional context by clicking the': 'Dodatni kontekst možete dodati klikom na',
      'button.': 'dugme.',
      'Ask a question to get started.': 'Postavite pitanje da biste započeli.',
      'Used web search': 'Korištena pretraga weba',
      'Generating response': 'Generisanje odgovora',
      'Apply to document': 'Primijeni na dokument',
      'Couldn\'t generate a response': 'Nije bilo moguće generisati odgovor',
      'The request failed or timed out. Check your connection and try again.': 'Zahtjev nije uspio ili je isteklo vrijeme čekanja. Provjerite vezu i pokušajte ponovo.',
      'Retry': 'Pokušaj ponovo',
      'Copied': 'Kopirano',
      'Unsupported file type': 'Nepodržan tip datoteke',
      'only': 'samo',
      'File too large': 'Datoteka je prevelika',
      'max': 'maks.',
      'Enter a valid URL': 'Unesite validan URL',
      'Current Document': 'Trenutni dokument',
      'Selected Content': 'Odabrani sadržaj',
      'File': 'Datoteka',
      'Could not read file': 'Nije bilo moguće pročitati datoteku',
      ...
      'The document appears to be empty or could not be converted.': 'Čini se da je dokument prazan ili ga nije bilo moguće konvertovati.',
      'Link': 'Link',
      'Current document': 'Trenutni dokument',
      'Add URL…': 'Dodaj URL…',
      'Add link': 'Dodaj link',
      'Hide changes': 'Sakrij izmjene',
      'Show changes': 'Prikaži izmjene',
      'Suggested rewrite': 'Predložena preformulacija',
      'Resize panel': 'Promijeni veličinu panela',
      'Collapse AI Chat': 'Suzi AI Chat',
      'Expand AI Chat': 'Proširi AI Chat',
      'Open the AI Chat Assistant panel': 'Otvori panel AI Chat asistenta',
