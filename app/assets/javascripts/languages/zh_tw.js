...
(function (global, factory) {
  ...
  FE.LANGUAGE['zh_tw'] = {
    translation: (_translation = {
      ...
      'Try again': '重試',
      // AI Improve Writing
      'Improve Writing': '改善寫作',
      'Improve writing': '改善寫作',
      'Accept All AI Changes': '接受所有 AI 變更',
      'Reject All AI Changes': '拒絕所有 AI 變更',
      'Improve Writing doesn\'t support selections that span multiple table cells. Please select text within a single cell.': '「改善寫作」不支援跨越多個表格儲存格的選取範圍。請在單一儲存格內選取文字。',
      'No improvements were suggested.': '未提出任何改善建議。',
      'The selection changed while waiting for a response. Please try again.': '等待回應時所選取的內容已變更。請重試。',
      'Could not match the AI response to the original content. Please try again.': '無法將 AI 回應與原始內容比對。請重試。',
      'AI request failed': 'AI 請求失敗',
      'Hide tracked changes': '隱藏追蹤的變更',
      'Show tracked changes': '顯示追蹤的變更',
      'Tracked changes': '追蹤的變更',
      'Proposed text': '建議的文字',
      'Suggest': '建議',
      'Reject All': '全部拒絕',
      'Accept All': '全部接受',
      ...
      'Stop dictation': '停止聽寫',
      'Listening': '正在聆聽...',
      'Speech recognition is not supported in this browser.': '此瀏覽器不支援語音識別。',
      'Microphone permission denied.': '麥克風權限已被拒絕。',
      'No microphone was found.': '未找到麥克風。',
      'Speech recognition failed.': '語音識別失敗。',
      'No speech detected.': '未偵測到語音。',
      'Could not transcribe the audio. Please try again.': '無法轉錄音訊，請重試。',
      ...
      'View more': '查看更多',
      'Show less': '收合',
      'Too many files attached': '附加的檔案過多',
      'Comments': '留言',
      'Couldn\'t apply this response to the document. Please try again.': '無法將此回覆套用到文件。請再試一次。',
      'Add context': '新增上下文',
      'Web search': '網路搜尋',
      'Reasoning': '推理',
      'Model': '模型',
      'Send': '傳送',
      'AI can make mistakes. Always review output for accuracy.': 'AI 可能會出錯，請務必查核輸出內容的準確性。',
      'Yes': '是',
      'No': '否',
      'Ask AI (web search & reasoning enabled)…': '詢問 AI（已啟用網路搜尋和推理）…',
      'Ask AI (web search enabled)…': '詢問 AI（已啟用網路搜尋）…',
      'Ask AI (reasoning enabled)…': '詢問 AI（已啟用推理）…',
      'Ask AI…': '詢問 AI…',
      'Hi! I\'m your writing assistant.': '您好！我是您的寫作助理。',
      'I can help you brainstorm, rewrite, translate, and summarize.': '我可以協助您進行腦力激盪、改寫、翻譯和摘要。',
      'You can add additional context by clicking the': '您可以點擊',
      'button.': '按鈕以新增更多上下文。',
      'Ask a question to get started.': '提出問題以開始使用。',
      'Used web search': '已使用網路搜尋',
      'Generating response': '正在生成回應',
      'Apply to document': '套用至文件',
      'Couldn\'t generate a response': '無法生成回應',
      'The request failed or timed out. Check your connection and try again.': '請求失敗或逾時。請檢查您的網路連線後重試。',
      'Retry': '重試',
      'Copied': '已複製',
      ...
      'File too large': '檔案過大',
      'max': '最多',
      'Enter a valid URL': '請輸入有效的網址',
      'Current Document': '目前文件',
      'Selected Content': '所選內容',
      'File': '檔案',
      'Could not read file': '無法讀取檔案',
      'DOCX support requires the mammoth.js library to be loaded (see the importFromWordMammoth option)': 'DOCX 支援需要載入 mammoth.js 程式庫（請參閱 importFromWordMammoth 選項）',
      'The document appears to be empty or could not be converted.': '文件似乎是空的或無法轉換。',
      'Link': '連結',
      'Current document': '目前文件',
      'Add URL…': '新增網址…',
      'Add link': '新增連結',
      'Hide changes': '隱藏變更',
      'Show changes': '顯示變更',
      'Suggested rewrite': '建議的改寫',
      'Resize panel': '調整面板大小',
      'Collapse AI Chat': '收合 AI 聊天',
      'Expand AI Chat': '展開 AI 聊天',
      'Open the AI Chat Assistant panel': '開啟 AI 聊天助理面板',
      'Switch Mode': '切換模式',
      'Editing': '編輯',
    ...
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, "Save", '儲存'), 'Restore version', '還原版本'), 'Current content will be replaced.', '目前內容將被取代。'), 'Delete version', '刪除版本'), "Back", '返回'), 'Total Edits', '總編輯次數'), 'Previous version', '上一個版本'), 'Next version', '下一個版本'), 'of', '共'), 'Compare With', '比較對象'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'VERSION HISTORY', '版本歷史'), 'All', '全部'), 'Named Versions', '已命名版本'), 'No content.', '無內容。'), "More", '更多'), 'Current Version', '目前版本'), 'Compare', '比較'), 'Anonymous', '匿名'), 'Untitled', '未命名'), 'See more', '查看更多'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Restore', '還原'), 'Rename', '重新命名'), 'Delete description', '刪除描述'), 'Edits', '編輯'), 'Previous change', '上一項變更'), 'Next change', '下一項變更'), 'Exit Comparison', '退出比較'), 'Select Version to Compare With', '選擇要比較的版本'), 'Show', '顯示'), 'COMPARE WITH', '比較對象'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'No other versions.', '沒有其他版本。'), 'No content to compare.', '沒有可比較的內容。'), 'Comparing', '正在比較'), 'against', '與'), 'Exit comparison', '退出比較'), 'Save this version', '儲存此版本'), 'View version history', '查看版本歷史'), 'Check for updates', '檢查更新'), 'Modification', '修改'), 'Suggestion', '建議'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Lecture', '講座'), 'Show Open', '顯示未解決'), 'Add Horizontal Line', '新增水平線'), 'Add Emoticon', '新增表情符號'), 'Add Icon', '新增圖示'), 'Add Special Character', '新增特殊字元'), 'Add Image', '新增圖片'), 'Add Table', '新增表格'), 'Add Video', '新增影片'), 'Add File', '新增檔案'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Add Code Snippet', '新增程式碼片段'), 'Add Anchor', '新增錨點'), 'Add Page Break', '新增分頁符號'), 'Moved', '已移動'), 'Moved Block', '區塊已移動'), 'Moved Table', '表格已移動'), 'Moved Image', '圖片已移動'), 'Moved Video', '影片已移動'), 'Moved Code Snippet', '程式碼片段已移動'), 'Moved Page Break', '分頁符號已移動'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Version Control', '版本控制'), 'Delete Table', '刪除表格'), 'Remove Table Header', '移除表頭'), 'Remove Table Footer', '移除表尾'), 'Delete Row', '刪除列'), 'Delete Column', '刪除欄'), 'Add Table Header', '新增表頭'), 'Add Table Footer', '新增表尾'), 'Insert Row Above', '在上方插入列'), 'Insert Row Below', '在下方插入列'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Insert Column Before', '在前方插入欄'), 'Insert Column After', '在後方插入欄'), 'Table Align', '表格對齊'), "Table Style", '表格樣式'), 'Table Cell', '表格儲存格'), 'Merge Cells', '合併儲存格'), 'Split Cell Vertically', '垂直分割儲存格'), 'Split Cell Horizontally', '水平分割儲存格'), 'Cell Operation', '儲存格操作'), 'Remove Cell Style', '移除儲存格樣式'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Added', '已新增'), 'Formatted', '已格式化'), 'Changed', '已變更'), 'left', '左'), 'right', '右'), 'center', '置中'), 'top', '頂部'), 'middle', '中間'), 'bottom', '底部'), 'Deleted', '已刪除'), _defineProperty(_defineProperty(_translation, 'justify', '左右對齊'), 'See less', '顯示較少')),
    direction: 'ltr'
  };
