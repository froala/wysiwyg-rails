...
(function (global, factory) {
  ...
  FE.LANGUAGE['he'] = {
    ...
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, "Advanced Options", 'אפשרויות מתקדמות'), 'Match case', 'התאם בין אותיות גדולות וקטנות'), 'Whole words only', 'רק מילים שלמות'), 'More Text', 'עוד טקסט'), 'More Paragraph', 'עוד סעיף'), 'More Rich', 'עוד  עשיר'), 'More Misc', 'שונות עוד'), 'Border', 'גבול'), "Dimensions", 'ממדים'), 'Select Table', 'בחר טבלה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Drag Table', 'גרור טבלה'), 'Select PageBreak', 'בחר הפסקת עמוד'), 'Drag PageBreak', 'גרור הפסקת עמוד'), 'Page Break', 'הפסקת עמוד'), 'Insert Anchor', 'הוספת עוגן'), 'There are no entries matching', 'אין רשומות תואמות'), 'Update Anchor', 'עדכון עוגן'), 'Edit Anchor', 'עריכת עוגן'), 'Anchor Name', 'שם העוגן'), 'Anchor Link', 'קישור העוגן'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Scroll to target', 'גלול אל היעד'), 'Enter the anchor name without space', 'הקלד את שם העוגן ללא רווח'), 'Anchor name already exists.', 'שם העוגן כבר קיים.'), 'Export to Word', 'ייצוא למילה'), 'Ensure that all required dependent libraries are available for the plugin to work.', 'ודא שכל ספריות התלויות הנדרשות זמינות כדי שהתוסף יעבוד.'), 'Import from Word', 'ייבוא מ-Word'), 'Please upload a valid file', 'אנא העלה קובץ תקין.'), 'File size must be less than', 'גודל הקובץ חייב להיות קטן מ-'), 'Code Snippet', 'קטע קוד'), 'Insert Code Snippet', 'הוסף קטע קוד'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Edit Code Snippet', 'ערוך קטע קוד'), 'Font Awesome', 'Font Awesome'), 'Web Application Icons', 'אייקוני יישומי ווב'), 'Accessibility Icons', 'אייקוני נגישות'), 'Hand Icons', 'אייקוני ידיים'), 'Transportation Icons', 'אייקוני תחבורה'), 'Gender Icons', 'אייקוני מגדר'), 'Form Control Icons', 'אייקוני פקדי טופס'), 'Payment Icons', 'אייקוני תשלום'), 'Chart Icons', 'אייקוני תרשימים'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Currency Icons', 'אייקוני מטבע'), 'Text Editor Icons', 'אייקוני עורך טקסט'), 'Brand Icons', 'אייקוני מותגים'), 'Default', 'ברירת מחדל'), 'Lower Alpha', 'אותיות לטיניות קטנות'), 'Lower Greek', 'אותיות יווניות קטנות'), 'Lower Roman', 'ספרות רומיות קטנות'), 'Upper Alpha', 'אותיות לטיניות גדולות'), 'Upper Roman', 'ספרות רומיות גדולות'), 'Circle', 'עיגול'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Disc', 'עיגול מלא'), 'Square', 'ריבוע'), 'Line Height', 'גובה שורה'), 'Single', 'בודד'), 'Double', 'כפול'), 'Insert File', 'הוספת קובץ'), 'Text Color', 'צבע טקסט'), 'Background Color', 'צבע רקע'), 'Gray', 'אפור'), 'Spaced', 'מרווח'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Uppercase', 'אותיות גדולות'), 'Rounded', 'מעוגל'), 'Bordered', 'עם מסגרת'), 'Shadow', 'צל'), 'Custom background colour input', 'הזנת צבע רקע מותאם'), 'Background colour picker', 'בורר צבע רקע'), 'Custom border colour input', 'הזנת צבע מסגרת מותאם'), 'Border colour picker', 'בורר צבע מסגרת'), 'Border colour', 'צבע מסגרת'), 'Inline Class', 'מחלקה פנימית'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Download PDF', 'הורדת PDF'), 'Dashed Borders', 'מסגרות מקווקוות'), 'Alternate Rows', 'שורות מתחלפות'), 'Highlighted', 'מודגש'), 'Thick', 'עבה'), 'Words', 'מילים'), 'Insert Files', 'הוסף קבצים'), 'Image file type is invalid.', 'סוג קובץ התמונה אינו תקין.'), 'File is too large.', 'הקובץ גדול מדי.'), 'Alternate Text', 'טקסט חלופי'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Your browser does not support HTML5 vídeo.', 'הדפדפן שלך אינו תומך ב-HTML5 וידאו.'), 'Transparent', 'שקוף'), 'Big Red', 'אדום גדול'), 'Small Blue', 'כחול קטן'), 'AI Shortcuts', 'קיצורי דרך של AI'), 'Ask AI to generate or refine text, adjusting its tone and language.', 'בקש מה-AI ליצור או לשפר טקסט, תוך התאמת הטון והשפה שלו.'), 'Ask AI to generate', 'בקש מה-AI ליצור'), 'AI responses can be inaccurate.', 'תגובות AI עשויות להיות לא מדויקות.'), 'Select a text layer to edit', 'בחר שכבת טקסט לעריכה'), 'Change Tone', 'שנה טון'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Translate To', 'תרגם ל'), 'Generating Response', 'יוצר תגובה'), 'Submit', 'שלח'), 'Stop', 'עצור'), 'Try again', 'נסה שוב'), 'To use AI features in Froala, you need to accept the AI Supplemental Terms.', 'לשימוש בתכונות בינה מלאכותית ב-Froala, עליך לאשר את התנאים המשלימים לבינה מלאכותית.'), 'Please set', 'אנא הגדר'), 'to', 'ל'), 'in your configuration to provide consent.', 'בתצורה שלך כדי לספק הסכמה.'), 'You can review the terms here:', 'ניתן לעיין בתנאים כאן:'), _defineProperty(_translation, 'View AI Supplemental Terms', 'הצג תנאים משלימים לבינה מלאכותית')),
    direction: 'rtl'
  };
