...
(function (global, factory) {
  ...
  FE.LANGUAGE['he'] = {
    ...
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, "Advanced Options", 'אפשרויות מתקדמות'), 'Match case', 'התאם בין אותיות גדולות וקטנות'), 'Whole words only', 'רק מילים שלמות'), 'More Text', 'עוד טקסט'), 'More Paragraph', 'עוד סעיף'), 'More Rich', 'עוד  עשיר'), 'More Misc', 'שונות עוד'), 'Border', 'גבול'), "Dimensions", 'ממדים'), 'Select Table', 'בחר טבלה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Drag Table', 'גרור טבלה'), 'Select PageBreak', 'בחר הפסקת עמוד'), 'Drag PageBreak', 'גרור הפסקת עמוד'), 'Page Break', 'הפסקת עמוד'), 'Insert Anchor', 'הוספת עוגן'), 'There are no entries matching', 'אין רשומות תואמות'), 'Update Anchor', 'עדכון עוגן'), 'Edit Anchor', 'עריכת עוגן'), 'Anchor Name', 'שם העוגן'), 'Anchor Link', 'קישור העוגן'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Scroll to target', 'גלול אל היעד'), 'Enter the anchor name without space', 'הקלד את שם העוגן ללא רווח'), 'Anchor name already exists.', 'שם העוגן כבר קיים.'), 'Export to Word', 'ייצוא למילה'), 'Ensure that all required dependent libraries are available for the plugin to work.', 'ודא שכל ספריות התלויות הנדרשות זמינות כדי שהתוסף יעבוד.'), 'Ensure that all required configurations and dependent libraries are available for the plugin to work as expected.', 'וודא שכל התצורות הנדרשות והספריות התלויות זמינות כדי שהתוסף יעבוד כצפוי.'), 'Import from Word', 'ייבוא מ-Word'), 'Please upload a valid file', 'אנא העלה קובץ תקין.'), 'File size must be less than', 'גודל הקובץ חייב להיות קטן מ-'), 'Code Snippet', 'קטע קוד'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Insert Code Snippet', 'הוסף קטע קוד'), 'Edit Code Snippet', 'ערוך קטע קוד'), 'Font Awesome', 'Font Awesome'), 'Web Application Icons', 'אייקוני יישומי ווב'), 'Accessibility Icons', 'אייקוני נגישות'), 'Hand Icons', 'אייקוני ידיים'), 'Transportation Icons', 'אייקוני תחבורה'), 'Gender Icons', 'אייקוני מגדר'), 'Form Control Icons', 'אייקוני פקדי טופס'), 'Payment Icons', 'אייקוני תשלום'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Chart Icons', 'אייקוני תרשימים'), 'Currency Icons', 'אייקוני מטבע'), 'Text Editor Icons', 'אייקוני עורך טקסט'), 'Brand Icons', 'אייקוני מותגים'), 'Default', 'ברירת מחדל'), 'Lower Alpha', 'אותיות לטיניות קטנות'), 'Lower Greek', 'אותיות יווניות קטנות'), 'Lower Roman', 'ספרות רומיות קטנות'), 'Upper Alpha', 'אותיות לטיניות גדולות'), 'Upper Roman', 'ספרות רומיות גדולות'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Circle', 'עיגול'), 'Disc', 'עיגול מלא'), 'Square', 'ריבוע'), 'Line Height', 'גובה שורה'), 'Single', 'בודד'), 'Double', 'כפול'), 'Insert File', 'הוספת קובץ'), 'Text Color', 'צבע טקסט'), 'Background Color', 'צבע רקע'), 'Gray', 'אפור'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Spaced', 'מרווח'), 'Uppercase', 'אותיות גדולות'), 'Rounded', 'מעוגל'), 'Bordered', 'עם מסגרת'), 'Shadow', 'צל'), 'Custom background colour input', 'הזנת צבע רקע מותאם'), 'Background colour picker', 'בורר צבע רקע'), 'Custom border colour input', 'הזנת צבע מסגרת מותאם'), 'Border colour picker', 'בורר צבע מסגרת'), 'Border colour', 'צבע מסגרת'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Inline Class', 'מחלקה פנימית'), 'Download PDF', 'הורדת PDF'), 'Dashed Borders', 'מסגרות מקווקוות'), 'Alternate Rows', 'שורות מתחלפות'), 'Highlighted', 'מודגש'), 'Thick', 'עבה'), 'Words', 'מילים'), 'Insert Files', 'הוסף קבצים'), 'Image file type is invalid.', 'סוג קובץ התמונה אינו תקין.'), 'File is too large.', 'הקובץ גדול מדי.'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Alternate Text', 'טקסט חלופי'), 'Your browser does not support HTML5 vídeo.', 'הדפדפן שלך אינו תומך ב-HTML5 וידאו.'), 'Transparent', 'שקוף'), 'Big Red', 'אדום גדול'), 'Small Blue', 'כחול קטן'), 'AI Shortcuts', 'קיצורי דרך של AI'), 'Ask AI to generate or refine text, adjusting its tone and language.', 'בקש מה-AI ליצור או לשפר טקסט, תוך התאמת הטון והשפה שלו.'), 'Ask AI to generate', 'בקש מה-AI ליצור'), 'AI responses can be inaccurate.', 'תגובות AI עשויות להיות לא מדויקות.'), 'Select a text layer to edit', 'בחר שכבת טקסט לעריכה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Change Tone', 'שנה טון'), 'Translate To', 'תרגם ל'), 'Generating Response', 'יוצר תגובה'), 'Submit', 'שלח'), 'Stop', 'עצור'), 'Try again', 'נסה שוב'), 'Improve Writing', 'שפר כתיבה'), 'Improve writing', 'שיפור הכתיבה'), 'Accept All AI Changes', 'אשר את כל שינויי הבינה המלאכותית'), 'Reject All AI Changes', 'דחה את כל שינויי הבינה המלאכותית'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Improve Writing doesn\'t support selections that span multiple table cells. Please select text within a single cell.', 'שפר כתיבה אינו תומך בבחירות המשתרעות על פני מספר תאי טבלה. אנא בחר טקסט בתוך תא בודד.'), 'No improvements were suggested.', 'לא הוצעו שיפורים.'), 'The selection changed while waiting for a response. Please try again.', 'הבחירה השתנתה בזמן ההמתנה לתגובה. אנא נסה שוב.'), 'Could not match the AI response to the original content. Please try again.', 'לא ניתן היה להתאים את תגובת הבינה המלאכותית לתוכן המקורי. אנא נסה שוב.'), 'AI request failed', 'בקשת הבינה המלאכותית נכשלה'), 'Hide tracked changes', 'הסתר שינויים במעקב'), 'Show tracked changes', 'הצג שינויים במעקב'), 'Tracked changes', 'שינויים במעקב'), 'Proposed text', 'טקסט מוצע'), 'Suggest', 'הצע'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Reject All', 'דחה הכל'), 'Accept All', 'אשר הכל'), 'Dictate', 'הכתיבי/הכתב'), 'Cancel recording', 'ביטול ההקלטה'), 'Stop dictation', 'הפסקת הכתבה'), 'Listening', 'מקשיב...'), 'Speech recognition is not supported in this browser.', 'זיהוי דיבור אינו נתמך בדפדפן זה.'), 'Microphone permission denied.', 'הרשאת מיקרופון נדחתה.'), 'No microphone was found.', 'לא נמצא מיקרופון.'), 'Speech recognition failed.', 'זיהוי הדיבור נכשל.'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'No speech detected.', 'לא זוהה דיבור.'), 'Could not transcribe the audio. Please try again.', 'לא ניתן היה לתמלל את השמע. נא לנסות שוב.'), 'Transcription failed', 'התמלול נכשל'), 'To use AI features in Froala, you need to accept the AI Supplemental Terms.', 'לשימוש בתכונות בינה מלאכותית ב-Froala, עליך לאשר את התנאים המשלימים לבינה מלאכותית.'), 'Please set', 'אנא הגדר'), 'to', 'ל'), 'in your configuration to provide consent.', 'בתצורה שלך כדי לספק הסכמה.'), 'You can review the terms here:', 'ניתן לעיין בתנאים כאן:'), 'View AI Supplemental Terms', 'הצג תנאים משלימים לבינה מלאכותית'), 'AI Chat', 'צ\'אט AI'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'View more', 'הצג עוד'), 'Show less', 'הצג פחות'), 'Too many files attached', 'צורפו יותר מדי קבצים'), 'Comments', 'תגובות'), 'Couldn\'t apply this response to the document. Please try again.', 'לא ניתן להחיל תגובה זו על המסמך. נסה שוב.'), 'Add context', 'הוספת הקשר'), 'Web search', 'חיפוש באינטרנט'), 'Reasoning', 'נימוק'), 'Model', 'מודל'), 'Send', 'שלח'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'AI can make mistakes. Always review output for accuracy.', 'בינה מלאכותית עלולה לטעות. בדקו תמיד את דיוק הפלט.'), 'Yes', 'כן'), 'No', 'לא'), 'Ask AI (web search & reasoning enabled)…', 'שאל את ה-AI (חיפוש באינטרנט ונימוק מופעלים)…'), 'Ask AI (web search enabled)…', 'שאל את ה-AI (חיפוש באינטרנט מופעל)…'), 'Ask AI (reasoning enabled)…', 'שאל את ה-AI (נימוק מופעל)…'), 'Ask AI…', 'שאל את ה-AI…'), 'Hi! I\'m your writing assistant.', 'שלום! אני עוזר הכתיבה שלך.'), 'I can help you brainstorm, rewrite, translate, and summarize.', 'אני יכול לעזור לך לגבש רעיונות, לנסח מחדש, לתרגם ולסכם.'), 'You can add additional context by clicking the', 'תוכל להוסיף הקשר נוסף על ידי לחיצה על כפתור'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'button.', '.'), 'Ask a question to get started.', 'שאל שאלה כדי להתחיל.'), 'Used web search', 'השתמש בחיפוש באינטרנט'), 'Generating response', 'יוצר תגובה'), 'Apply to document', 'החל על המסמך'), 'Couldn\'t generate a response', 'לא ניתן היה ליצור תגובה'), 'The request failed or timed out. Check your connection and try again.', 'הבקשה נכשלה או שפג תוקפה. בדוק את החיבור שלך ונסה שוב.'), 'Retry', 'נסה שוב'), 'Copied', 'הועתק'), 'Unsupported file type', 'סוג קובץ לא נתמך'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'only', 'בלבד'), 'File too large', 'הקובץ גדול מדי'), 'max', 'מקסימום'), 'Enter a valid URL', 'הזן כתובת URL תקינה'), 'Current Document', 'המסמך הנוכחי'), 'Selected Content', 'תוכן נבחר'), 'File', 'קובץ'), 'Could not read file', 'לא ניתן לקרוא את הקובץ'), 'DOCX support requires the mammoth.js library to be loaded (see the importFromWordMammoth option)', 'תמיכה ב-DOCX מחייבת טעינה של ספריית mammoth.js (ראה את האפשרות importFromWordMammoth)'), 'The document appears to be empty or could not be converted.', 'נראה שהמסמך ריק או שלא ניתן היה להמיר אותו.'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Link', 'קישור'), 'Current document', 'המסמך הנוכחי'), 'Add URL…', 'הוסף כתובת URL…'), 'Add link', 'הוסף קישור'), 'Hide changes', 'הסתר שינויים'), 'Show changes', 'הצג שינויים'), 'Suggested rewrite', 'שכתוב מוצע'), 'Resize panel', 'שנה את גודל הפאנל'), 'Collapse AI Chat', 'כווץ את צ\'אט ה-AI'), 'Expand AI Chat', 'הרחב את צ\'אט ה-AI'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Open the AI Chat Assistant panel', 'פתח את פאנל עוזר צ\'אט ה-AI'), 'Switch Mode', 'החלף מצב'), 'Editing', 'עריכה'), 'Edit document with real-time sync', 'עריכת מסמך עם סנכרון בזמן אמת'), 'Suggesting', 'הצעות'), 'Add suggestions as Yjs-tracked changes', 'הוסף הצעות כשינויים במעקב של Yjs'), 'Viewing', 'צפייה'), 'Read-only — no edits allowed', 'לקריאה בלבד — לא ניתן לערוך'), 'Add Comment', 'הוסף תגובה'), 'Version History', 'היסטוריית גרסאות'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Hide Comments', 'הסתר תגובות'), 'Open', 'פתוח'), 'Resolved', 'נפתר'), 'Show comments', 'הצג תגובות'), 'No suggestions or comments yet.', 'עדיין אין הצעות או תגובות.'), 'No resolved suggestions or comments.', 'אין הצעות או תגובות שנפתרו.'), 'View All', 'הצג הכל'), 'Open comment from', 'פתח תגובה מאת'), 'more users', 'משתמשים נוספים'), 'Add', 'הוסף'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Add Space', 'הוסף רווח'), 'Add Paragraph', 'הוסף פסקה'), 'Add Link', 'הוסף קישור'), 'with', 'ב־'), 'Format', 'עיצוב'), 'Removed', 'הוסר'), 'Accept', 'אשר'), 'Reject', 'דחה'), 'Accepted', 'אושר'), 'Rejected', 'נדחה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Menu', 'תפריט'), 'Edit', 'ערוך'), 'Re-open', 'פתח מחדש'), 'Resolve', 'סמן כפתור'), 'Reply', 'השב'), 'View All Replies', 'הצג את כל התגובות'), 'View Less', 'הצג פחות'), 'comment or tag with @', 'הגב או תייג באמצעות @'), 'Comment', 'תגובה'), "Update", 'עדכן'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Saving...', 'שומר...'), 'Saved', 'נשמר'), 'Auto Save', 'שמירה אוטומטית'), 'Last saved', 'נשמר לאחרונה'), 'Click to save a version now', 'לחץ כדי לשמור גרסה כעת'), 'just now', 'זה עתה'), 's ago', 'שנ׳ לפני'), 'm ago', 'דק׳ לפני'), 'h ago', 'שע׳ לפני'), 'd ago', 'ימים לפני'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Add to Version History', 'הוסף להיסטוריית הגרסאות'), 'Rename Version', 'שנה שם לגרסה'), 'Name this version', 'תן שם לגרסה זו'), 'Edit description', 'ערוך תיאור'), 'Title', 'כותרת'), 'Title is required.', 'נדרשת כותרת.'), 'Description (optional)', 'תיאור (אופציונלי)'), "Save", 'שמור'), 'Restore version', 'שחזר גרסה'), 'Current content will be replaced.', 'התוכן הנוכחי יוחלף.'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Delete version', 'מחק גרסה'), "Back", 'חזרה'), 'Total Edits', 'סה״כ עריכות'), 'Previous version', 'גרסה קודמת'), 'Next version', 'גרסה הבאה'), 'of', 'מתוך'), 'Compare With', 'השווה עם'), 'VERSION HISTORY', 'היסטוריית גרסאות'), 'All', 'הכל'), 'Named Versions', 'גרסאות בעלות שם'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'No content.', 'אין תוכן.'), "More", 'עוד'), 'Current Version', 'הגרסה הנוכחית'), 'Compare', 'השווה'), 'Anonymous', 'אנונימי'), 'Untitled', 'ללא כותרת'), 'See more', 'ראה עוד'), 'Restore', 'שחזר'), 'Rename', 'שנה שם'), 'Delete description', 'מחק תיאור'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Edits', 'עריכות'), 'Previous change', 'שינוי קודם'), 'Next change', 'שינוי הבא'), 'Exit Comparison', 'צא מההשוואה'), 'Select Version to Compare With', 'בחר גרסה להשוואה'), 'Show', 'הצג'), 'COMPARE WITH', 'השווה עם'), 'No other versions.', 'אין גרסאות נוספות.'), 'No content to compare.', 'אין תוכן להשוואה.'), 'Comparing', 'משווה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'against', 'מול'), 'Exit comparison', 'צא מההשוואה'), 'Save this version', 'שמור גרסה זו'), 'View version history', 'הצג היסטוריית גרסאות'), 'Check for updates', 'בדוק עדכונים'), 'Modification', 'שינוי'), 'Suggestion', 'הצעה'), 'Lecture', 'הרצאה'), 'Show Open', 'הצג פתוחים'), 'Add Horizontal Line', 'הוסף קו אופקי'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Add Emoticon', 'הוסף אימוג׳י'), 'Add Icon', 'הוסף סמל'), 'Add Special Character', 'הוסף תו מיוחד'), 'Add Image', 'הוסף תמונה'), 'Add Table', 'הוסף טבלה'), 'Add Video', 'הוסף וידאו'), 'Add File', 'הוסף קובץ'), 'Add Code Snippet', 'הוסף קטע קוד'), 'Add Anchor', 'הוסף עוגן'), 'Add Page Break', 'הוסף מעבר עמוד'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Moved', 'הועבר'), 'Moved Block', 'בלוק הועבר'), 'Moved Table', 'טבלה הועברה'), 'Moved Image', 'תמונה הועברה'), 'Moved Video', 'וידאו הועבר'), 'Moved Code Snippet', 'קטע קוד הועבר'), 'Moved Page Break', 'מעבר עמוד הועבר'), 'Version Control', 'בקרת גרסאות'), 'Delete Table', 'מחק טבלה'), 'Remove Table Header', 'הסר כותרת טבלה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'Remove Table Footer', 'הסר כותרת תחתונה של טבלה'), 'Delete Row', 'מחק שורה'), 'Delete Column', 'מחק עמודה'), 'Add Table Header', 'הוסף כותרת טבלה'), 'Add Table Footer', 'הוסף כותרת תחתונה לטבלה'), 'Insert Row Above', 'הוסף שורה מעל'), 'Insert Row Below', 'הוסף שורה מתחת'), 'Insert Column Before', 'הוסף עמודה לפני'), 'Insert Column After', 'הוסף עמודה אחרי'), 'Table Align', 'יישור טבלה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, "Table Style", 'סגנון טבלה'), 'Table Cell', 'תא טבלה'), 'Merge Cells', 'מזג תאים'), 'Split Cell Vertically', 'פצל תא אנכית'), 'Split Cell Horizontally', 'פצל תא אופקית'), 'Cell Operation', 'פעולת תא'), 'Remove Cell Style', 'הסר סגנון תא'), 'Added', 'נוסף'), 'Formatted', 'עוצב'), 'Changed', 'שונה'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translation, 'left', 'שמאל'), 'right', 'ימין'), 'center', 'מרכז'), 'top', 'למעלה'), 'middle', 'אמצע'), 'bottom', 'למטה'), 'Deleted', 'נמחק'), 'justify', 'יישור מלא'), 'See less', 'הצג פחות')),
    direction: 'rtl'
  };
