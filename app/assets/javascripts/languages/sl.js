...
(function (global, factory) {
  ...
  FE.LANGUAGE['sl'] = {
    translation: (_translation = {
      ...
      // AI Improve Writing
      'Improve Writing': 'Izboljšaj besedilo',
      'Improve writing': 'Izboljšaj besedilo',
      'Accept All AI Changes': 'Sprejmi vse spremembe AI',
      'Reject All AI Changes': 'Zavrni vse spremembe AI',
      'Improve Writing doesn\'t support selections that span multiple table cells. Please select text within a single cell.': 'Izboljšava besedila ne podpira izbire, ki se razteza čez več celic tabele. Izberite besedilo znotraj ene celice.',
      'No improvements were suggested.': 'Ni bilo predlaganih izboljšav.',
      'The selection changed while waiting for a response. Please try again.': 'Izbira se je med čakanjem na odgovor spremenila. Poskusite znova.',
      'Could not match the AI response to the original content. Please try again.': 'Odgovora AI ni bilo mogoče ujemati z izvirno vsebino. Poskusite znova.',
      'AI request failed': 'Zahteva AI ni uspela',
      'Hide tracked changes': 'Skrij sledene spremembe',
      'Show tracked changes': 'Pokaži sledene spremembe',
      'Tracked changes': 'Sledene spremembe',
      'Proposed text': 'Predlagano besedilo',
      'Suggest': 'Predlagaj',
      'Reject All': 'Zavrni vse',
      'Accept All': 'Sprejmi vse',
      // AI Speech to Text
      'Dictate': 'Narekovanje',
      'Cancel recording': 'Prekliči snemanje',
      'Stop dictation': 'Ustavi narekovanje',
      'Listening': 'Poslušam...',
      'Speech recognition is not supported in this browser.': 'Prepoznavanje govora v tem brskalniku ni podprto.',
      'Microphone permission denied.': 'Dovoljenje za mikrofon je zavrnjeno.',
      'No microphone was found.': 'Mikrofon ni bil najden.',
      'Speech recognition failed.': 'Prepoznavanje govora ni uspelo.',
      'No speech detected.': 'Govor ni bil zaznan.',
      'Could not transcribe the audio. Please try again.': 'Posnetka ni bilo mogoče prepisati. Prosimo, poskusite znova.',
      'Transcription failed': 'Prepis ni uspel',
      // AI Terms Consent
      ...
      'Too many files attached': 'Priloženih je preveč datotek',
      'Comments': 'Komentarji',
      'Couldn\'t apply this response to the document. Please try again.': 'Tega odgovora ni bilo mogoče uporabiti v dokumentu. Poskusite znova.',
      'Add context': 'Dodaj kontekst',
      'Web search': 'Spletno iskanje',
      'Reasoning': 'Sklepanje',
      'Model': 'Model',
      'Send': 'Pošlji',
      'AI can make mistakes. Always review output for accuracy.': 'AI lahko naredi napake. Vedno preverite točnost odgovora.',
      'Yes': 'Da',
      'No': 'Ne',
      'Ask AI (web search & reasoning enabled)…': 'Vprašaj AI (spletno iskanje in sklepanje omogočena)…',
      'Ask AI (web search enabled)…': 'Vprašaj AI (spletno iskanje omogočeno)…',
      'Ask AI (reasoning enabled)…': 'Vprašaj AI (sklepanje omogočeno)…',
      'Ask AI…': 'Vprašaj AI…',
      'Hi! I\'m your writing assistant.': 'Pozdravljeni! Sem vaš pomočnik za pisanje.',
      'I can help you brainstorm, rewrite, translate, and summarize.': 'Lahko vam pomagam pri zbiranju idej, prepisovanju, prevajanju in povzemanju.',
      'You can add additional context by clicking the': 'Dodaten kontekst lahko dodate s klikom na',
      'button.': 'gumb.',
      'Ask a question to get started.': 'Zastavite vprašanje za začetek.',
      'Used web search': 'Uporabljeno spletno iskanje',
      'Generating response': 'Ustvarjanje odgovora',
      'Apply to document': 'Uporabi v dokumentu',
      'Couldn\'t generate a response': 'Odgovora ni bilo mogoče ustvariti',
      'The request failed or timed out. Check your connection and try again.': 'Zahteva ni uspela ali je potekla časovna omejitev. Preverite povezavo in poskusite znova.',
      'Retry': 'Poskusi znova',
      'Copied': 'Kopirano',
      'Unsupported file type': 'Nepodprta vrsta datoteke',
      'only': 'samo',
      ...
      'File': 'Datoteka',
      'Could not read file': 'Datoteke ni bilo mogoče prebrati',
      'DOCX support requires the mammoth.js library to be loaded (see the importFromWordMammoth option)': 'Podpora za DOCX zahteva naloženo knjižnico mammoth.js (glejte možnost importFromWordMammoth)',
      'The document appears to be empty or could not be converted.': 'Dokument je videti prazen ali ga ni bilo mogoče pretvoriti.',
      'Link': 'Povezava',
      'Current document': 'Trenutni dokument',
      'Add URL…': 'Dodaj URL…',
      'Add link': 'Dodaj povezavo',
      'Hide changes': 'Skrij spremembe',
      'Show changes': 'Pokaži spremembe',
      'Suggested rewrite': 'Predlagano prepisano besedilo',
      'Resize panel': 'Spremeni velikost podokna',
      'Collapse AI Chat': 'Strni AI klepet',
      'Expand AI Chat': 'Razširi AI klepet',
      'Open the AI Chat Assistant panel': 'Odpri podokno pomočnika AI klepeta',
