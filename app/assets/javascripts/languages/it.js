...
(function (global, factory) {
  ...
  FE.LANGUAGE['it'] = {
    translation: (_translation = {
      ...
      'Try again': 'Riprova',
      // AI Improve Writing
      'Improve Writing': 'Migliora Scrittura',
      'Improve writing': 'Migliora scrittura',
      'Accept All AI Changes': 'Accetta tutte le modifiche AI',
      'Reject All AI Changes': 'Rifiuta tutte le modifiche AI',
      'Improve Writing doesn\'t support selections that span multiple table cells. Please select text within a single cell.': 'Migliora Scrittura non supporta selezioni che si estendono su più celle della tabella. Seleziona il testo all\'interno di una singola cella.',
      'No improvements were suggested.': 'Non sono stati suggeriti miglioramenti.',
      'The selection changed while waiting for a response. Please try again.': 'La selezione è cambiata durante l\'attesa di una risposta. Riprova, per favore.',
      'Could not match the AI response to the original content. Please try again.': 'Impossibile abbinare la risposta dell\'AI al contenuto originale. Riprova, per favore.',
      'AI request failed': 'Richiesta AI non riuscita',
      'Hide tracked changes': 'Nascondi modifiche tracciate',
      'Show tracked changes': 'Mostra modifiche tracciate',
      'Tracked changes': 'Modifiche tracciate',
      'Proposed text': 'Testo proposto',
      'Suggest': 'Suggerisci',
      ...
      'Speech recognition is not supported in this browser.': 'Il riconoscimento vocale non è supportato in questo browser.',
      'Microphone permission denied.': 'Autorizzazione microfono negata.',
      'No microphone was found.': 'Nessun microfono trovato.',
      'Speech recognition failed.': 'Riconoscimento vocale non riuscito.',
      'No speech detected.': 'Nessun discorso rilevato.',
      'Could not transcribe the audio. Please try again.': 'Impossibile trascrivere l\'audio. Riprova.',
      ...
      'Too many files attached': 'Troppi file allegati',
      'Comments': 'Commenti',
      'Couldn\'t apply this response to the document. Please try again.': 'Impossibile applicare questa risposta al documento. Riprova.',
      'Add context': 'Aggiungi contesto',
      'Web search': 'Ricerca web',
      'Reasoning': 'Ragionamento',
      'Model': 'Modello',
      'Send': 'Invia',
      'AI can make mistakes. Always review output for accuracy.': 'L\'IA può commettere errori. Verifica sempre l\'accuratezza del risultato.',
      'Yes': 'Sì',
      'No': 'No',
      'Ask AI (web search & reasoning enabled)…': 'Chiedi all\'IA (ricerca web e ragionamento attivi)…',
      'Ask AI (web search enabled)…': 'Chiedi all\'IA (ricerca web attiva)…',
      'Ask AI (reasoning enabled)…': 'Chiedi all\'IA (ragionamento attivo)…',
      'Ask AI…': 'Chiedi all\'IA…',
      'Hi! I\'m your writing assistant.': 'Ciao! Sono il tuo assistente di scrittura.',
      'I can help you brainstorm, rewrite, translate, and summarize.': 'Posso aiutarti a trovare idee, riscrivere, tradurre e riassumere.',
      'You can add additional context by clicking the': 'Puoi aggiungere ulteriore contesto facendo clic sul pulsante',
      'button.': '.',
      'Ask a question to get started.': 'Fai una domanda per iniziare.',
      'Used web search': 'Ricerca web utilizzata',
      'Generating response': 'Generazione della risposta',
      'Apply to document': 'Applica al documento',
      'Couldn\'t generate a response': 'Impossibile generare una risposta',
      'The request failed or timed out. Check your connection and try again.': 'La richiesta non è riuscita o è scaduta. Controlla la connessione e riprova.',
      'Retry': 'Riprova',
      'Copied': 'Copiato',
      ...
      'DOCX support requires the mammoth.js library to be loaded (see the importFromWordMammoth option)': 'Il supporto DOCX richiede il caricamento della libreria mammoth.js (vedi l\'opzione importFromWordMammoth)',
      'The document appears to be empty or could not be converted.': 'Il documento sembra vuoto oppure non è stato possibile convertirlo.',
      'Link': 'Link',
      'Current document': 'Documento corrente',
      'Add URL…': 'Aggiungi URL…',
      'Add link': 'Aggiungi link',
      'Hide changes': 'Nascondi modifiche',
      'Show changes': 'Mostra modifiche',
      'Suggested rewrite': 'Riscrittura suggerita',
      'Resize panel': 'Ridimensiona pannello',
      'Collapse AI Chat': 'Comprimi Chat AI',
      'Expand AI Chat': 'Espandi Chat AI',
      'Open the AI Chat Assistant panel': 'Apri il pannello dell\'assistente Chat AI',
